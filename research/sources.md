...
## 7. Дополнения (исследование v2, 2026-09-25)
- Плата за перенос непокрытой позиции (маржинальные займы денег/бумаг, в т.ч. шорт акций), в день: Трейдер — 40 ₽ до 50 тыс., 75 ₽ до 100 тыс., 180 ₽ до 250 тыс., 350 ₽ до 500 тыс., 700 ₽ до 1 млн, 1 750 ₽ до 2,5 млн, 3 500 ₽ до 5 млн, 6 900 ₽ до 10 млн, 0,068% до 25 млн; Премиум — 35/70/175/340/680/1 700/3 400/6 800 ₽, 0,066% до 25 млн. ≈ 0,068–0,07% в день ≈ 25% годовых. — https://www.tbank.ru/invest/help/brokerage/account/margin/about/ — 2026-09-25 — VERIFIED (Firecrawl, direct quote)
- Дивиденды 2025-09…2026-09 (дата T-1, размер) для 12 акций — research/dividends.csv, источник smart-lab.ru/q/<TICKER>/dividend/ — 2026-09-25 — SECONDARY (агрегатор; даты сверены с ценовыми гэпами в данных)
